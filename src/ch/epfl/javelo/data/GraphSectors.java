...
public record GraphSectors(ByteBuffer buffer) {
    ...
    public List<Sector> sectorsInArea(PointCh center, double distance) {
        ...
        int topEIndex = (int) (((center.e() + distance) - SwissBounds.MIN_E) / (2.7265625 * 1000)); //!!!!! REMETTRE LES VALEURS POUR LES ADAPTER A UNE TAILLE DE 128*128
        ...
        int topNIndex = (int) (((center.n() + distance) - SwissBounds.MIN_N) / (1.7265625 * 1000)); //!!!!! REMETTRE LES VALEURS POUR LES ADAPTER A UNE TAILLE DE 128*128
